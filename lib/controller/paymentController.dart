...
class homePayment extends State<paymentController>{
  String _isInit = "false";
  String cardNumber = '';
  String expiryDate = '';
  String cardNameHolder = 'NOM PRENOM';
  String cvv = '';
  bool cvvFocused = false;
  String TEST_KEY='kfjfkjsfkl';
  @override
  void initState() {
  ...
  Future<void> initPaymentSDK() async {
    ...
    try {
      bool isSuccess = await FlutterCheckoutPayment.init(key: "${TEST_KEY}");
